      ...
      <div className="grid max-w-320 grid-cols-32 w-full max-md:max-w-[23.4375rem] max-lg:grid-cols-16 md:max-lg:max-w-192 2xl:max-w-440">
        ...
        <div className="grid relative py-45 content-center col-start-1 [grid-column-end:-4] grid-cols-subgrid max-lg:py-22.5 max-lg:col-end-[-1]">
          <span className="block col-start-2 col-end-16 text-6xl [font-weight:335] leading-[3.5625rem] tracking-[-1.8px] text-balance [font-feature-settings:'calt'] md:text-[5rem] md:leading-19 md:tracking-[-2.4px] xl:text-[7.5rem] xl:leading-28.5 xl:tracking-[-3.6px]" data-component="heading">
            ...
            <span className="h-full flex flex-col items-start gap-2.5">
              ...
              <span className="block">
                {" "}
                <span className="block [animation-name:appear-mask-in-from-right] [animation-duration:2s] [animation-timing-function:cubic-bezier(0.76,_0,_0.24,_1)] [animation-fill-mode:forwards]">
                  {" "}
              ...
              {" "}
              <span className="block text-[3.4375rem] [font-weight:420] leading-[3.4375rem] tracking-[-1.1px] max-md:text-[2rem] max-md:leading-8 max-md:tracking-[-0.64px] md:max-lg:text-[2.5rem] md:max-lg:leading-10 md:max-lg:tracking-[-0.8px]" data-component="heading">
                {" "}
                <span className="block">
                  {" "}
                  <span className="block [animation-name:appear-mask-in-from-right] [animation-duration:2s] [animation-timing-function:cubic-bezier(0.76,_0,_0.24,_1)] [animation-delay:0.2s] [animation-fill-mode:forwards]">
                    {" "}
                    <span className="inline-block relative">
                      {" "}
                      <span className="block xl:whitespace-nowrap">
                        {" specialists. One workflow. "}
                      </span>
                      {" "}
                      <span className="block" />
                    </span>
          ...
          <span className="block mt-10 col-start-2 col-end-9 text-color-004 [font-family:'Akkurat_Mono-dea851e1d19028b9',_'Akkurat_Mono-dea851e1d19028b9_fallback:_Courier_New',_monospace] text-[0.6875rem] leading-[0.875rem] tracking-[0.33px] uppercase h-[3.125rem] max-md:[grid-column-end:-2]">
            ...
            <span className="block">
              {" "}
              <span className="block [animation-name:appear-mask-in-from-right] [animation-duration:2s] [animation-timing-function:cubic-bezier(0.76,_0,_0.24,_1)] [animation-delay:0.3s] [animation-fill-mode:forwards]">
                {" "}
                <span className="inline-block relative">
                  {" "}
                  <span className="block">
          ...
          {" "}
          <span className="block max-w-[39.75rem] mt-32.5 mb-[2.8125rem] col-start-2 col-end-9 [font-weight:358] leading-[1.375rem] tracking-[0.32px] max-lg:max-w-[37.2625rem] max-lg:mt-50 max-lg:mb-7.5 max-md:[grid-column-end:-2] max-lg:text-[0.9375rem] max-lg:leading-[1.3125rem] max-lg:tracking-[0.3px]">
            {" "}
            <span className="block leading-6.5 max-lg:leading-[1.5rem]">
              {" Each agent owns a distinct part of the reconciliation journey. Together, they move every transaction from incoming data to a verified, documented outcome. "}
            </span>
            {" "}
          </span>
          {" "}
