...
const DEFAULT_HANDLE_LABELS = ["agentic", "financial", "operations"]
...
function __OriginkitBase_VectorWordmark(props: VectorWordmarkProps) {
    const {
        ...
        damping = 60,
        handles,
        handleLabels = DEFAULT_HANDLE_LABELS,
        style,
    } = props
    ...
    live.current.hg = hg
    live.current.handleLabels = handleLabels
    ...
    useEffect(() => {
        ...
        function writeLabels() {
            ...
            for (let i = 0; i < HANDLES; i += 1) {
                ...
                el.textContent = L.handleLabels[i] ?? ""
            }
        }
