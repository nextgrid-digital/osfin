...
interface KineticTextRevealProps extends Omit<HTMLAttributes<HTMLSpanElement>, "children"> {
  ...
  delay?: number;
  /** Waits until the text enters the viewport before autoPlay runs. */
  startOnView?: boolean;
  /** When startOnView is set, play only the first time it enters. */
  once?: boolean;
  /** Root margin for the viewport intersection observer. */
  inViewMargin?: string;
  ...
  function KineticTextReveal(
    ...
    useEffect(() => {
      ...
      const observer = new IntersectionObserver(
        ...
        { rootMargin: inViewMargin, threshold: 0.2 },
      );
